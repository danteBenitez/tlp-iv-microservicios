...
export interface IPurchaseRepository {
    ...
    createDetails(purchaseId: string, details: (Omit<IPurchaseDetail, "purchaseId" | "purchaseDetailId">)[]): Promise<IPurchaseDetail[] | null>
}
...
export class PostgresPurchaseRepository implements IPurchaseRepository {
    ...
    async createDetails(purchaseId: string, details: (Omit<IPurchaseDetail, "purchaseId" | "purchaseDetailId">)[]): Promise<IPurchaseDetail[] | null> {
        ...
        await this.purchaseDetailModel.bulkCreate(details.map(d => ({
            ...d,
            purchaseId
        })));
