...
interface RequestValidator {
  validateRequest<TSchema extends Schema>(
    req: Request,
    schema: TSchema
  ): Promise<ValidationResult<TSchema>>;
  validateRequestBody<TSchema extends Schema>(
    req: Request,
    schema: TSchema
  ): Promise<ValidationResult<TSchema>>;
}
...
export class ValidationAdapter implements RequestValidator {
  async validateRequest<TSchema extends Schema>(
    req: Request,
    schema: TSchema
  ): Promise<ValidationResult<TSchema>> {
  ...
  async validateRequestBody<TSchema extends Schema>(
    req: Request,
    schema: TSchema
  ): Promise<ValidationResult<TSchema>> {
